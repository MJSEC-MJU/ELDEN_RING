...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        llm_provider=os.getenv("RA_LLM_PROVIDER", "codex"),
        codex_command=os.getenv("RA_CODEX_COMMAND", "codex"),
        codex_model=os.getenv("RA_CODEX_MODEL"),
        claude_command=os.getenv("RA_CLAUDE_COMMAND", "claude"),
        claude_model=os.getenv("RA_CLAUDE_MODEL"),
        llm_timeout_sec=int(os.getenv("RA_LLM_TIMEOUT_SEC", "180")),
    )
