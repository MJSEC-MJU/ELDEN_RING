...
# ============================================================
# Step 6: Install Redis (Phase 간 메시지 브로커)
# ============================================================
install_redis() {
    log_info "Installing Redis message broker..."
    ...
    helm upgrade --install redis bitnami/redis \
        --namespace elden-monitoring \
        --values "$K8S_DIR/messaging/redis/values.yaml" \
        --wait --timeout 5m

    log_ok "Redis installed (redis-master.elden-monitoring:6379)"
}

# ============================================================
# Step 7: Deploy Harness Delegate
# ============================================================
...
verify_installation() {
    ...
    kubectl get pods -n elden-monitoring -l app.kubernetes.io/name=redis --no-headers 2>/dev/null || echo "  Not installed"
    ...
    echo "  Redis:      redis-master.elden-monitoring:6379 (클러스터 내부)"
    echo ""
    echo "  Next steps:"
